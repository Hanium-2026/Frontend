...
export default function ElderTopBlock({ children, minHeight = 200, padBottom = 44 }) {
  const insets = useSafeAreaInsets();
  return (
    <View style={{ minHeight: minHeight + insets.top }}>
      <LinearGradient
        colors={[T.blue, T.blueDark]}
        start={{ x: 0, y: 0 }}
        end={{ x: 0, y: 1 }}
        style={{ paddingTop: insets.top + 14, paddingBottom: padBottom, paddingHorizontal: 20, minHeight: minHeight + insets.top, borderBottomLeftRadius: 28, borderBottomRightRadius: 28, overflow: 'hidden' }}
      >
