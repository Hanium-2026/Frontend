...
## 커밋 컨벤션 (README.md 기준 — 반드시 준수)

커밋 시 README.md에 정의된 형식을 따를 것. 형식: `이모지 타입: 작업 내용`
...
예시:
```
✨ Feat: 웹 폰 프레임 목업 UI 추가
🐛 Fix: ElderHome CTA 카드 간격 오류 해결
🎨 Design: 보호자 대시보드 타일 레이아웃 수정
```

> **Claude에게**: 커밋 메시지 작성 시 위 형식을 항상 사용할 것. 영문 커밋 메시지 금지.
